...
// Functor: FixedValueFunctor
// A functor always returning a given fixed value.
template <typename ArgumentType, typename ResultType, ResultType val>
struct FixedValueFunctor {
	 typedef ArgumentType argument_type;
	 typedef ResultType result_type;
	 result_type operator()( const ArgumentType& ) { return val; }
};
