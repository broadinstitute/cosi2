...
#define PRINT3(X,Y,Z) do { } while(0)
#define PRINT4(X,Y,Z,W) do { } while(0)
#define PRINT5(X,Y,Z,W,T) do { } while(0)
#define PRINT6(X,Y,Z,W,T,U) do { } while(0)
#define PRINT7(X,Y,Z,W,T,U,V) do { } while(0)
#define PRINT8(V1,V2,V3,V4,V5,V6,V7,V8) do { } while(0)
#define PRINT9(V1,V2,V3,V4,V5,V6,V7,V8,V9) do { } while(0)
#define PRINT10(V1,V2,V3,V4,V5,V6,V7,V8,V9,V10) do { } while(0)
#define PRINT11(V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11) do { } while(0)
#define PRINT12(V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12) do { } while(0)
#define PRINT13(V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12,V13) do { } while(0)
#define PRINT14(V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12,V13,V14) do { } while(0)
#define PRINT15(V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12,V13,V14,V15) do { } while(0)
#define PRINT16(V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11,V12,V13,V14,V15,V16) do { } while(0)
