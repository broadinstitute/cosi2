//
// Header: random_access_skip_list
//
// Skip list with random access, partial sums, and efficient (lazy) range updates.  Each skip stores the number of
// elements skipped, and the sum of their values.  Additionally, it supports efficient range updates.
//
// Adapted from Pete Goodliffe's skip list implementation.
// See http://goodliffe.blogspot.com/2011/12/skip-lists-c-stl-style-implementation.html
...
template <typename T,
          ...
          typename LevelGenerator = detail::skip_list_level_generator<32>,
					typename WeightExtractor = detail::FixedValueFunctor<T,int,0>,
					typename WeightType = typename WeightExtractor::result_type >

struct rasl_cfg {
	 typedef T value_type;
	 typedef Compare compare_type;
	 typedef Allocator allocator_type;
	 typedef LevelGenerator level_generator_type;
...
///
/// @see skip_list
template <typename T, typename CFG = rasl_cfg<T> >
class random_access_skip_list
{
private:
	 typedef typename CFG::compare_type Compare;
	 typedef typename CFG::allocator_type Allocator;
	 typedef typename CFG::level_generator_type LevelGenerator;
	 
    typedef typename detail::rasl_impl<T,CFG> impl_type;
...
inline
bool operator==(const random_access_skip_list<T,CFG> &lhs, const random_access_skip_list<T,CFG> &rhs)
{
...
{
    template <class T, class CFG>
    void swap(goodliffe::random_access_skip_list<T,CFG> &lhs, goodliffe::random_access_skip_list<T,CFG> &rhs)
    {
        lhs.swap(rhs);
    }
}
...
template <class T, class CFG>
inline
random_access_skip_list<T,CFG>::random_access_skip_list(const allocator_type &alloc_)
:   impl(alloc_)
{
}
...
template <class InputIterator>
inline
random_access_skip_list<T,CFG>::random_access_skip_list(InputIterator first, InputIterator last, const allocator_type &alloc_)
:   impl(alloc_)
{
    assign(first, last);
}
...
template <class T, class CFG>
inline
random_access_skip_list<T,CFG>::random_access_skip_list(const random_access_skip_list &other)
...
template <class T, class CFG>
inline
random_access_skip_list<T,CFG>::random_access_skip_list(const random_access_skip_list &other, const allocator_type &alloc_)
:   impl(alloc_)
{
    assign(other.begin(), other.end());
}
...
template <class T, class CFG>
inline
random_access_skip_list<T,CFG> &
random_access_skip_list<T,CFG>::operator=(const random_access_skip_list<T,CFG> &other)
{
    assign(other.begin(), other.end());
    return *this;
}
...
template <typename InputIterator>
inline
void random_access_skip_list<T,CFG>::assign(InputIterator first, InputIterator last)
{
    clear();
...
template <class T, class CFG>
inline
typename random_access_skip_list<T,CFG>::reference
random_access_skip_list<T,CFG>::front()
{
    assert_that(!empty());
...
template <class T, class CFG>
inline
typename random_access_skip_list<T,CFG>::const_reference
random_access_skip_list<T,CFG>::front() const
{
    assert_that(!empty());
    return impl.front()->value;
}
...
inline
typename random_access_skip_list<T,CFG>::reference
random_access_skip_list<T,CFG>::back()
{
    assert_that(!empty());
...
inline
typename random_access_skip_list<T,CFG>::const_reference
random_access_skip_list<T,CFG>::back() const
{
    assert_that(!empty());
    return impl.one_past_end()->prev->value;
}
...
template <class T, class CFG>
inline
void random_access_skip_list<T,CFG>::clear()
{
    impl.remove_all();
}
...
template <class T, class CFG>
inline
typename random_access_skip_list<T,CFG>::insert_by_value_result
random_access_skip_list<T,CFG>::insert(const value_type &value)
{
...
template <class T, class CFG>
inline
typename random_access_skip_list<T,CFG>::iterator
random_access_skip_list<T,CFG>::insert(const_iterator hint, const value_type &value)
{
...
inline
void
random_access_skip_list<T,CFG>::insert(InputIterator first, InputIterator last)
{
...
template <class T, class CFG>
inline
typename random_access_skip_list<T,CFG>::size_type
random_access_skip_list<T,CFG>::erase(const value_type &value)
{
...
inline
typename random_access_skip_list<T,CFG>::iterator
random_access_skip_list<T,CFG>::erase(const_iterator position)
{
...
inline
typename random_access_skip_list<T,CFG>::iterator
random_access_skip_list<T,CFG>::erase(const_iterator first, const_iterator last)
{
...
inline
typename random_access_skip_list<T,CFG>::size_type
random_access_skip_list<T,CFG>::count(const value_type &value) const
{
...
inline
typename random_access_skip_list<T,CFG>::iterator
random_access_skip_list<T,CFG>::find(const value_type &value)
{
    node_type *node = impl.find(value);
    return impl.is_valid(node) && detail::equivalent(node->value, value, impl.less)
        ? iterator(&impl, node)
...
template <class T, class CFG>
inline
typename random_access_skip_list<T,CFG>::const_iterator
random_access_skip_list<T,CFG>::find(const value_type &value) const
{
    const node_type *node = impl.find(value);
    return impl.is_valid(node) && detail::equivalent(node->value, value, impl.less)
...
inline
typename random_access_skip_list<T,CFG>::const_reference
random_access_skip_list<T,CFG>::operator[](unsigned index) const
{
...
inline
void
random_access_skip_list<T,CFG>::erase_at(size_type index)
{
...
inline
typename random_access_skip_list<T,CFG>::iterator
random_access_skip_list<T,CFG>::iterator_at(unsigned index)
{
    node_type *node = impl.at(index);
...
inline
typename random_access_skip_list<T,CFG>::const_iterator
random_access_skip_list<T,CFG>::iterator_at(unsigned index) const
{
    const node_type *node = impl.at(index);
...
inline
typename random_access_skip_list<T,CFG>::size_type
random_access_skip_list<T,CFG>::index_of(const const_iterator &i) const
{
...
template <typename T, typename SPAN, typename WeightType>
struct rasl_node
{
    ...
    weight_type  *span_sum; ///< effectively weight_type span_sum[level+1];
};
...
public:
    ...
    typedef T                                   value_type;
	 ...
	 typedef typename CFG::allocator_type Allocator;
	 typedef typename CFG::level_generator_type LevelGenerator;
	 typedef typename CFG::weight_type weight_type;
	 typedef typename CFG::weight_extractor_type weight_extractor_type;
    ...
    typedef LevelGenerator                      generator_type;    
	 typedef rasl_node<T, size_type, weight_type>             node_type;
...
private:
    ...
    typedef typename Allocator::template rebind<weight_type>::other    weight_allocator;
    ...
    size_type find_chain(const value_type &value, node_type **chain, size_type *indexes) const;
	 size_type find_chain(const value_type &value, node_type **chain, size_type *indexes, weight_type *weights) const;
    ...
    size_type       item_count;
	  weight_extractor_type weight_extractor;
    ...
    node_type *allocate(unsigned level)
    {
        ...
        node->span_sum  = weight_allocator(alloc).allocate(level+1, (void*)0);
        node->level = level;
        for (unsigned n = 0; n <= level; ++n) node->span[n] = 1;
				std::fill( node->span_sum, node->span_sum + level + 1, 0 );
#ifdef SKIP_LIST_IMPL_DIAGNOSTICS
    ...
    void deallocate(node_type *node)
    {
        ...
        span_allocator(alloc).deallocate(node->span, node->level+1);
				weight_allocator(alloc).deallocate( node->span_sum, node->level+1 );
...
template <class T, class CFG>
inline
rasl_impl<T,CFG>::rasl_impl(const allocator_type &alloc_)
:   alloc(alloc_),
    levels(0),
...
template <class T, class CFG>
inline
typename rasl_impl<T,CFG>::node_type *
rasl_impl<T,CFG>::find(const value_type &value) const
{
...
// Method: find_chain
//
// Find at each level the rightmost node whose value is strictly less than a given value.
// If value is smaller than everything in the list (or the list is empty), this returns head
// at each level.  If value is greater than everything in the list and the list is non-empty,
// returns the last node at each level (which may be head), but does not return tail.
//
// Input:
//
//    value - the key we're searching for
//
// Output:
//
//    chain - chain[l] points to rightmost node of level l for which chain[l]->value < value
//    indexes - indexes[l] stores the index of the node in chain[l]
//    cum_weights - cum_weights[l] stores the sum of weights of nodes up to and including the node in chain[l]
//  
//
template <class T, class CFG>
inline
typename rasl_impl<T,CFG>::size_type
rasl_impl<T,CFG>::find_chain(const value_type &value, node_type **chain, size_type *indexes, weight_type *cum_weights) const
{
    size_type index = 0;
		weight_type cum_weight = 0;
    node_type *cur = head;
    ...
    while (l)
    {
        ...
        {
            index += cur->span[l];
						cum_weight += cur->span_sum[l];
            cur = cur->next[l];
            impl_assert_that(l <= cur->level);
        }
        chain[l]   = cur;
        indexes[l] = index;
				cum_weights[l] = cum_weight;
    }
...
inline
typename rasl_impl<T,CFG>::size_type
rasl_impl<T,CFG>::find_chain(const value_type &value, node_type **chain, size_type *indexes) const
{
    size_type index = 0;
    node_type *cur = head;
    unsigned l = num_levels;
...
inline
typename rasl_impl<T,CFG>::size_type
rasl_impl<T,CFG>::find_chain(const node_type *node, node_type **chain, size_type *indexes) const
{
...
inline
typename rasl_impl<T,CFG>::size_type
rasl_impl<T,CFG>::find_end_chain(node_type **chain, size_type *indexes) const
{
    size_type index = 0;
    node_type *cur = head;
    unsigned l = num_levels;
...
inline
typename rasl_impl<T,CFG>::node_type*
rasl_impl<T,CFG>::insert(const value_type &value, node_type *hint)
{
    const unsigned level = new_level();

    node_type *chain[num_levels]   = {0};
    size_type  indexes[num_levels] = {0};
    weight_type  sums[num_levels] = {0};
    size_type  index               = find_chain(value, chain, indexes, sums);
    ...
    alloc.construct(&new_node->value, value);
		...
		weight_type new_value = weight_extractor( value );
    ...
    for (unsigned l = 0; l < num_levels; ++l)
    {
        ...
        else
        {
            ...
            weight_type prev_span_sum = chain[l]->span_sum[l];
            chain[l]->span[l] = index+1-indexes[l];
            new_node->span[l] = prev_span - (index-indexes[l]);
...
inline
void
rasl_impl<T,CFG>::remove(node_type *node)
{
    assert_that(is_valid(node));
...
inline
void 
rasl_impl<T,CFG>::remove_between(node_type *first, node_type *last)
{
...
inline
typename rasl_impl<T,CFG>::node_type *
rasl_impl<T,CFG>::at(size_type index)
{
...
template <class T, class CFG>
inline
const typename rasl_impl<T,CFG>::node_type *
rasl_impl<T,CFG>::at(size_type index) const
{
...
inline
typename rasl_impl<T,CFG>::size_type
rasl_impl<T,CFG>::index_of(const node_type *node) const
{
    node_type *chain[num_levels]   = {0};
    size_type  indexes[num_levels] = {0};
...
template <class T, class CFG>
inline
unsigned rasl_impl<T,CFG>::new_level()
{    
...
template <class T, class CFG>
inline
void rasl_impl<T,CFG>::swap(rasl_impl &other)
{
    using std::swap;
...
inline
void rasl_impl<T,CFG>::dump(STREAM &s) const
{
...
template <class T, class CFG>
inline
bool rasl_impl<T,CFG>::check() const
{
