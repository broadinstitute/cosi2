...
struct seg: private boost::noncopyable {
	 ...
	 bool contains( loc_t loc ) const { return beg <= loc && loc <= end; }
...
using seglist_detail::seglist_first_seg_const;
using seglist_detail::seglist_last_seg_const;
...
using seglist_detail::seglist_intersects;

using seglist_detail::seglist_run_tests;

using seglist_detail::seglist_beg;
using seglist_detail::seglist_end;

using seglist_detail::seglist_find_seg;
