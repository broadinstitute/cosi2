...
/*
 * $Id: mtwist.h,v 1.1 2011/05/06 23:13:09 sfs Exp $
 *
...
extern unsigned long   	mts_seed(mt_state* state);
...
extern unsigned long   	mt_seed(void);	/* Choose seed from random input. */
					/* ..Prefers /dev/urandom; uses time */
					/* ..if /dev/urandom unavailable. */
					/* ..Only gives 32 bits of entropy. */
